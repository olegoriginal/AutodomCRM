        ...
        >
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-sm">
                Если аккаунт не является персонализированным (Аккаунт является
                персонализированным если на нем сидит один человек), оставьте
                поля "Выберите сотрудника" и "Выберите место работы пустым"
                пустым. В противном случае ваше имя и место работы будут
                подставляться при создании и обработки заказов.
              </p>
            </div>
          </div>
        </div>
